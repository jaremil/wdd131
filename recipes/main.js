...
//     recipeHTML = `
//     <img class="recipeImg" src="${recipes.image}">
//     <p class="recipeTag">${recipes.tags}</p>
//     <p class="recipeName">${recipes.name}</p>
//     <p class="recipeName">${recipes.rating}</p>
...
function displayRecipe(recipe) {
    let recipeHTML = `
        ...
        <p class="recipeRating">Rating: ${recipe.rating}</p>
